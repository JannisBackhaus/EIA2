...
(function (Aufgabe05) {
    ...
    function generateCart(_event) {
        ...
        if (target_else.id == "tree_form") {
            ...
            node.appendChild(name);
            name.classList.add("overview_item");
            name.innerHTML = (Aufgabe05.holder[index].name);
            let price = document.createElement("a");
            node2.appendChild(price);
            price.classList.add("overview_item");
            price.innerHTML = (Aufgabe05.holder[index].price + "");
            ...
            for (let i = 0; i < Aufgabe05.balls.length; i++) {
                ...
                if (checkbox.checked == true) {
                    ...
                    node.appendChild(name);
                    name.classList.add("overview_item");
                    name.innerHTML = (Aufgabe05.balls[i].name);
                    let price = document.createElement("a");
                    node2.appendChild(price);
                    price.classList.add("overview_item");
                    price.innerHTML = (Aufgabe05.balls[i].price + "");
                }
            }
            ...
            for (let i = 0; i < Aufgabe05.tinsel.length; i++) {
                ...
                if (checkbox.checked == true) {
                    ...
                    node.appendChild(name);
                    name.classList.add("overview_item");
                    name.innerHTML = (Aufgabe05.tinsel[i].name);
                    let price = document.createElement("a");
                    node2.appendChild(price);
                    price.classList.add("overview_item");
                    price.innerHTML = (Aufgabe05.tinsel[i].price + "");
                }
            }
            ...
            node.appendChild(name);
            name.classList.add("overview_item");
            name.innerHTML = (Aufgabe05.lights[index].name);
            let price = document.createElement("a");
            node2.appendChild(price);
            price.classList.add("overview_item");
            price.innerHTML = (Aufgabe05.lights[index].price + "");
            ...
            node.appendChild(name);
            name.classList.add("overview_item");
            name.innerHTML = (Aufgabe05.top[index].name);
            let price = document.createElement("a");
            node2.appendChild(price);
            price.classList.add("overview_item");
            price.innerHTML = (Aufgabe05.top[index].price + "");
