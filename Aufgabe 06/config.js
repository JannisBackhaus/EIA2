        ...
        for (let i = 0; i < config.data.length; i++) {
            ...
            if (config.data[i].form_type == "dropdown") {
                ...
                for (let k = 0; k < config.data[i].items.length; k++) {
                    ...
                    dropdown.setAttribute("name", config.data[i].categ_name + "_Option");
            ...
            if (config.data[i].form_type == "radio") {
                for (let k = 0; k < config.data[i].items.length; k++) {
                    ...
                    radiobutton.setAttribute("name", config.data[i].categ_name + "_Radiogroup");
                    radiobutton.innerHTML = config.data[i].items[k].name;
                    radiobutton.setAttribute("id", config.data[i].categ_name + "_radio" + i);
                    let radiolabel = document.createElement("label");
                    div1.appendChild(radiobutton);
                    radiolabel.classList.add("formelements");
                    radiolabel.setAttribute("for", config.data[i].categ_name + "_radio" + i);
            ...
            if (config.data[i].form_type == "checkbox") {
                for (let k = 0; k < config.data[i].items.length; k++) {
                    ...
                    checkbox.setAttribute("name", config.data[i].categ_name + "_Checkbox");
                    checkbox.innerHTML = config.data[i].items[k].name;
                    checkbox.setAttribute("id", config.data[i].categ_name + "_checkbox" + i);
                    let checkboxlabel = document.createElement("label");
                    div1.appendChild(checkbox);
                    checkboxlabel.classList.add("formelements");
                    checkboxlabel.setAttribute("for", config.data[i].categ_name + "_checkbox" + i);
